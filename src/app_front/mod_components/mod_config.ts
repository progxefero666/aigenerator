 ...
 */
export class ModuleComponentsConfig {
    ...
    public static readonly MENU: Option[]=[
        ModuleComponentsConfig.OPT_CREATE_MODELS,
        ModuleComponentsConfig.OPT_CREATES_SERVICES,
        ModuleComponentsConfig.OPT_MODEL_CARDS,
        ModuleComponentsConfig.OPT_MODEL_FOLDER,
    ];
    public static readonly MENU_ACT_OPTION: Option = ModuleComponentsConfig.MENU[0];
